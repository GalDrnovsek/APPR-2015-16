...
- število prebivalcev(tip double)
- število velemojstrov(tip double)
- BDP na prebivalca(tip double)
- delež BDP namenjen za izdatke za izobraževanje(tip double)
...
Zaenkrat sem narisal 2 zemljevida.
...
drugi pa število velemojstrov za posamezno državo:
